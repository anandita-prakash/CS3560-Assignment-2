...
public class AdminControlPanel extends JFrame
{
	// GUI components
		...
		private JButton addUserButton, addGroupButton, openUserViewButton, 
			userTotButton, groupTotButton, messageTotButton, positiveButton;
		...
		// AdminControlPanel instance using Singleton
		...
		private AdminControlPanel()
		{
			...
			userTotButton.addActionListener(new totalUsersListener());
			...
			groupTotButton.addActionListener(new totalGroupsListener());
			...
			messageTotButton.addActionListener(new totalTweetsListener());
			...
			positiveButton.addActionListener(new numPositiveListener());
		...
		private class addUserListener implements ActionListener 
		{
			...
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					...
					VisitorTotal newUser = new IncrementVisitor();
					user.accept(newUser);
		...
		private class totalUsersListener implements ActionListener
		{
			@Override
			public void actionPerformed(ActionEvent e) {
				IncrementVisitor userTot = new IncrementVisitor();
				JOptionPane.showMessageDialog(null, "Total Users: " + userTot.getTotalUsers());
			}
		}
		
		private class totalGroupsListener implements ActionListener
		{
			@Override
			public void actionPerformed(ActionEvent e) {
				IncrementVisitor groupTot = new IncrementVisitor();
				JOptionPane.showMessageDialog(null, "Total Groups: " + groupTot.getTotalGroups());
			}
		}
		
		private class totalTweetsListener implements ActionListener
		{
			@Override
			public void actionPerformed(ActionEvent e) {
				IncrementVisitor tweetTot = new IncrementVisitor();
				JOptionPane.showMessageDialog(null, "Total Tweets: " + tweetTot.getTotalTweets());
			}
		}
		
		private class numPositiveListener implements ActionListener
		{
			@Override
			public void actionPerformed(ActionEvent e) {
				IncrementVisitor posTot = new IncrementVisitor();
				IncrementVisitor tweetVisitor = new IncrementVisitor();
				double numTot = tweetVisitor.getTotalTweets();
				double numPos = posTot.getTotalPositive();
